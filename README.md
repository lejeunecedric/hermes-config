...
   
The setup is pretty straight forward, but there may be some hiccups : the Signal connection needs an external service, signal-cli  that proved a little difficult.  
Then you have a  
   
